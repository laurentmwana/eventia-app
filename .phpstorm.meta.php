...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.F:\laravel-app\eventia-app\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.F:\\laravel-app\\eventia-app\\public\\storage','inertia.ssr.enabled','inertia.ssr.url',
...
'debugbar.theme','debugbar.debug_backtrace_limit','image.driver','image.options.autoOrientation','image.options.decodeAnimation',
'image.options.blendingColor','image.options.strip','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'event.index','event.create','event.store','event.show','event.edit',
'event.update','event.destroy','guest.index','guest.create','guest.store',
'guest.show','guest.edit','guest.update','guest.destroy','guest-seat.index',
'guest-seat.create','guest-seat.store','guest-seat.show','guest-seat.edit','guest-seat.update',
'guest-seat.destroy','storage.local',);
...
'validation.attributes.work','validation.attributes.year','fr.0','actions.accept','actions.action',
